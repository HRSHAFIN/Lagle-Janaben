...
<body class="bg-gray-50 flex items-center justify-center min-h-screen">
  <div class="max-w-md w-full mx-4 bg-white rounded-2xl p-8 border border-gray-100 shadow-sm text-center">
    ...
    <div class="space-y-3">
      ...
      <a href="/?ssl_status=cancel&tran_id={$tran_id}" class="block w-full border border-gray-200 text-gray-700 bg-white rounded-xl py-3.5 text-sm font-semibold hover:bg-gray-50 transition-colors">Return to Checkout</a>
    </div>
  </div>
</body>
</html>
